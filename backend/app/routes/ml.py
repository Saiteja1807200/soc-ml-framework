...
async def predict_anomaly(activity_data: dict, db: AsyncSession = Depends(get_db)):
    """
    ...
    try:
        ...
        if is_anomaly and 'username' in activity_data:
            # Here you would normally fetch or create activity record first
            # For demo, we create alert directly
            pass  # Alert creation logic can be extended here
